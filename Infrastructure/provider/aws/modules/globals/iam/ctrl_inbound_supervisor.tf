...
resource aws_iam_role_policy_attachment inbound_supervisor_lambda_basic_execution {
  role       = aws_iam_role.inbound_supervisor.name
  policy_arn = local.lambda_basic_execution_role_arn
}

resource aws_iam_role_policy_attachment inbound_supervisor_cloudwatch_metric_write_access {
  role       = aws_iam_role.inbound_supervisor.name
